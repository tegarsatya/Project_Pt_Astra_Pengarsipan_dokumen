	<?php
		if (isset($_REQUEST['edit'])) {
			...
			//jika mengubah file		
				$query 	= "UPDATE dokumen_masuk SET id_dok='$id_dok', nama_dok='$nama_dok', jenis_dok='$jenis_dok', tanggal_dok='$tanggal_dok',  isi_ringkas='$isi_ringkas', file='$file' WHERE id_dok='$_GET[id_dok]'";
				$sql   	= mysqli_query($connect, $query);
				if ($sql) {
			...
			//jika tidak mengubah file
				$query 	= "UPDATE surat_masuk SET id_dok='$id_dok', nama_dok='$Snama_dok', jenis_dok='$jenis_dok', tanggal_dok='$tanggal_dok',  isi_ringkas='$isi_ringkas', file='$file' WHERE id_dok='$_GET[id_dok]'";
				$sql   	= mysqli_query($connect, $query);
				if ($sql) {
					echo '<script language="javascript">
						  window.alert("Data berhasil di ubah")
