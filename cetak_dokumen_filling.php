<title>Lembar Cetak Dokumen Filling</title>
	...
	<div class="row" align="center">
		...
		<table cellspacing="0" cellspacing="5" >
			<?php
				...
				$query	= "SELECT * FROM dokumen_filling WHERE id_dok='$id_dok'";
				$sql    = mysqli_query($connect, $query);
				while ($data = mysqli_fetch_array($sql)) {
	
			?>
				<tr>
					<td class="tgh" id="lbr" colspan="5">DOKUMEN FILLING</td>
				</tr>
				<tr>
				...
				<tr>
					<td id="right" width="200"><strong> File :</strong></td>
					<td id="left" colspan="2"><?php echo $data['file'];?></td>
				</tr>
				<tr>
