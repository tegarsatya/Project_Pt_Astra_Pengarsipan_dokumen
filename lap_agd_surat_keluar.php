...
?>
	<style type="text/css">
		...
		<div class="header">
			...
			<h6 class="text">LAPORAN DOKUMEN Keluar<br> PT. ASTRA DAIHATSU  <br> </h6>
			<h4></h4>
			...
			<?php
				if (isset($_POST['cetak'])) {
					...
					if ($_REQUEST['dari_tanggal']=="" || $_REQUEST['sampai_tanggal']=="") {
						echo '<script>
								window.location.href="./index.php?page=agd_surat_keluar";
						 	 </script>';
						die();
					}else{
						$query	= "SELECT * FROM dokumen_keluar WHERE tanggal_dok BETWEEN '$dari_tanggal' AND '$sampai_tanggal'";
						$sql 	= mysqli_query($connect, $query);
			?>
			<div class="col-md-10">
				<h4><strong>DOKUMEN KELUAR DARI TANGGAL <?php echo $dari_tanggal_indo ?> SAMPAI TANGGAL <?php echo $sampai_tanggal_indo; ?></strong></h4>
			</div>	
				<table id="table" border="1" cellspacing="0" cellpadding="5" width="100%">
					...
					<tbody>
						...
						<td><?php echo IndonesiaTgl($data['tanggal_dok'])?></td>
					</tbody>
					<?php 
								}
							}else{
								echo '<tr><td colspan="9"><center><h2><strong>Tidak ada Agenda Dokumen Keluar</></strong></h2></center></td></tr>';
							}
							}
						}	
					?>
