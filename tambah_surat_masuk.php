	<?php
		if (isset($_REQUEST['submit'])) {
			...
			$query 		= "INSERT INTO dokumen_masuk VALUES('$id_dok', '$nama_dok', '$jenis_dok', '$tanggal_dok', '$isi_ringkas', '$file')";
	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Form Tambah Dokumen Masuk</h2>
