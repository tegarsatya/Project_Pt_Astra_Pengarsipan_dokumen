			...
			<?php
				if (isset($_POST['cetak'])) {
					...
					if ($_REQUEST['dari_tanggal']=="" || $_REQUEST['sampai_tanggal']=="") {
						echo '<script>
								window.location.href="./index.php?page=agd_index_dokumen";
						 	 </script>';
						die();
					}else{
						$query	= "SELECT * FROM index_dokumen WHERE tanggal BETWEEN '$dari_tanggal' AND '$sampai_tanggal'";
			...
			<div class="col-md-10">
				...
				<table id="table" border="1" cellspacing="0" cellpadding="5" width="100%">
					...
					<?php 
								...
								echo '<tr><td colspan="9"><center><h2><strong>Tidak ada Data Agenda Index Dokumen </></strong></h2></center></td></tr>';
							}
							}
						}	
					?>
