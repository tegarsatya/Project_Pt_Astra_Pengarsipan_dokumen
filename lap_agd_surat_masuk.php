...
?>
	...
	<div class="row" align="center">
		<div class="header">
			...
			<h6 class="text">LAPORAN DOKUMEN MASUK<br> PT. ASTRA DAIHATSU  <br> </h6>
			...
			<?php
				if (isset($_POST['cetak'])) {
					...
					if ($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == "") {
						...
						$query	= "SELECT * FROM dokumen_masuk WHERE tanggal_dok BETWEEN '$dari_tanggal' AND '$sampai_tanggal'";
						$sql    = mysqli_query($connect, $query);
			?>
			<div class="col-md-10">
				<h4><strong>AGENDA DOKUMEN MASUK DARI TANGGAL <?php echo $dari_tanggal_indo ?> SAMPAI TANGGAL <?php echo $sampai_tanggal_indo; ?></strong></h4>
			</div>
				<table id="table" border="1" cellspacing="0" cellpadding="5" width="100%">
					...
					<?php
								...
								echo '<tr><td colspan="9"><center><h2><strong>Tidak ada Agenda Dokumen Masuk</></strong></h2></center></td></tr>';
							}
						}
						}
					?>
