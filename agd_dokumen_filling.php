	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Data Dokumen Filling</h2>&nbsp; &nbsp; 
							<a href="export_xls_fi.php" type="submit" name="xls" class="btn btn-success"><i class="fa fa-download"></i> Export All Data To Excel</a>
					...
					<div class="x_content">
						<form class="form-horizontal form-label-left" method="post" action="lap_agd_dokumen_filling.php" target="_blank">
							...
							<div class="form-group">
								<div class="col-md-6 col-md-offset-3">
									...
									<a href="index.php?page=agd_dokumen_filling" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
								</div>
							</div>
						</form>
					</div>
